...
extern uint8_t EEMEM  fan_pwm_steps_number_address;  // 8
extern uint16_t EEMEM fan_pwm_frequency_address;     // 6-7

extern uint16_t EEMEM sunraise_duration_minutes_address;  // 4-5
